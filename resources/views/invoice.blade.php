...
<body>
        ...
        <div class="row">
            ...
            <div class="col-lg-6" style="text-align: left;">
                <div class="text-white text-center ml-5 mb-2 font-weight-bold align-text-bottom" style="height: 110px; width: 150px; background-color: #FAA730;">
                    <p style="padding-top: 80px;">INVOICE</p>
                </div>
                <div class="ml-5 mt-4">
                ...
                <div style="border-top: 1px solid gray; margin-top: 25px; margin-right: 35px; margin-left: 42px;">
                    ...
                    <p class="ml-1" style="float: left; color:#FAA730;">Inovice #{{ $newNumber }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Totaal price with tax -->
                    <div class="float-right fixed-bottom" style="border-top: 1px solid gray; bottom: 200px; right:16px; color: #4A4143; margin-top: 52px;">
                        <div class="mt-3">
                        ...
                        <!-- notice -->      
                        <div class=" d-inline-block pt-4 " style=" color: #4A4143; width:250px;  font-size: 12px;">
                            Graag het totaalbedrag binnen 10 werkdagen overmaken op het onderstaande rekeningnummer ov.v. het factuurnummer.   
                        </div>
                        <!-- end of notice -->
                    </div>
                </div>
